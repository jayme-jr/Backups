---
title: "Avaliação do Tutor PET S"
header-includes:
  - \usepackage{float}
output: 
  pdf_document
...
Segundo a avaliação dos petianos e petianas, o tutor ou tutora se faz 
presente nas reuniões, discute as atividades, participa delas e as 
supervisiona, incentiva a participação dos integrantes em eventos, 
cumpre seus afazeres em dia e respeita ideologias diferentes. Já as 
outras respostas onde houve diferença entre as respostas dificultou a
análise, dado o número pequeno de integrantes que responderam.
...
Fica evidente que os petianos e petianas tem respostas parecidas na
maioria das questões, dado o desvio padrão pequeno, chegando a ter
unanimidades nas questões x3, x10 e x13, onde o desvio é zero. Única 
exceção é a x14 que não tem desvio, pois só teve uma resposta 
considerada.
